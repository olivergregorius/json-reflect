...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/olivergregorius/json-reflect/build.yml?branch=main&label=Gradle%20Build&logo=github)](https://github.com/olivergregorius/json-reflect/actions/workflows/build.yml)
